...
def main():
    ...
    while (time < modelingTime):
        ...
        for num in range(positionCarbon.shape[1]):
            ...
            for dim in range(3):
                ...
                if num == 0:
                    ...
                    print(res)
                    # print(positionCarbon[pceusoTime][num])
                    # return
                # print(res)
        ...
        # # fig.canvas.draw()
        # # fig.canvas.mpl_connect('button_release_event', update_position)
        # plt.title('time = {} \n phix = 50.0..0.0'.format(allTime))
        # # plt.legend(handles=p)
        # # plt.show()
        # plt.savefig("./picts/carbon_3d_speed_{0:04d}.png".format(allTime))
        # plt.clf()
        ...
        # plt.clf()
        print("asdadasdasd")
        print(positionCarbon[0][0])
        print(positionCarbon[1][0])
        # print(positionCarbon[0][0])
        # return
